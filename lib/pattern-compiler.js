 ...
 */
var determineCompiler = function determineCompiler (options, patternObject, patternDestPath, paths) {
 ...
 */
var compileTemplate = function compileTemplate (patternCompilerData) {
  ...
  if(patternCompilerData.data === undefined){
    patternCompilerData.data = {};
  }
